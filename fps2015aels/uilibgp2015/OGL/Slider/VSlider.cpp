...
ID::VSlider::VSlider(unsigned int w,
		     unsigned int h,
...
ID::VSlider::~VSlider(void)
{
}

int	ID::VSlider::ClickDown(ID::Event* e)
{
...
int	ID::VSlider::Motion(ID::Event* e)
{
	if (!this->_OnMotion(e))
		return 0;
...
int	ID::VSlider::RefreshSurface(int x, int y)
{
...
void	ID::VSlider::AddChild(ID::Drawable*)
{
	throw 988;
}

void	ID::VSlider::AddChild(ID::Control*)
{
	throw 987;
}

bool	ID::VSlider::_OnClickDown(Event* e)
{
...
bool	ID::VSlider::_OnMotion(Event* e)
{
	if (this->GetOnScreen() == true && this->GetEnable() == true &&
	    (ID::Env::GetInstance()->GetDrawableFocused() == this ||
	    (this->_surface != NULL &&
...
ID::Drawable*	ID::VSlider::GetBarSurface(void)
{
	return &(this->__bar);
}

void		ID::VSlider::SetHeightLink(unsigned int hL)
{
...
unsigned int	ID::VSlider::GetValue(void) const
{
