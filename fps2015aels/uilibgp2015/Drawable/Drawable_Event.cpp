...
int	ID::Drawable::Click(ID::Event* e)
{
	if (!this->_OnClick(e))
		return 0;
	...
	this->_PushDblClickEvent(e);
	gettimeofday(&(this->_lastClick), NULL); // Dont care if failed
	return 1;
}

int	ID::Drawable::DoubleClick(ID::Event* e)
{
...
int	ID::Drawable::ClickDown(ID::Event* e)
{
...
int	ID::Drawable::ClickUp(ID::Event* e)
{
	...
	this->_PushClickEvent(e);
	return 1;
}

int	ID::Drawable::Enter(ID::Event* e)
{
	if (!this->_OnEnter(e))
		return 0;
...
int	ID::Drawable::Leave(ID::Event* e)
{
	if (!this->_OnLeave(e))
		return 0;
...
int	ID::Drawable::Motion(ID::Event* e)
{
	if (!this->_OnMotion(e))
		return 0;
	std::list<ID::Drawable*>::reverse_iterator	d_rit;
...
int	ID::Drawable::KeyUp(ID::Event* e)
{
	if (!this->_OnKeyUp(e))
		return 0;
...
int	ID::Drawable::KeyDown(ID::Event* e)
{
...
int	ID::Drawable::FocusEnter(ID::Event* e)
{
...
int	ID::Drawable::FocusLeave(ID::Event* e)
{
...
int	ID::Drawable::EnableChange(ID::Event* e)
{
...
int	ID::Drawable::ScreenChange(ID::Event* e)
{
...
int	ID::Drawable::Resize(ID::Event* e)
{
	if (!this->_OnResize(e))
		return 0;
	std::list<ID::Drawable*>::reverse_iterator	d_rit;
...
int	ID::Drawable::Quit(ID::Event* e)
{
	if (!this->_OnQuit(e))
		return 0;
	std::list<ID::Drawable*>::reverse_iterator	d_rit;
...
int	ID::Drawable::UserEvent(ID::Event* e)
{
